...
def run_commands(args):
    ...
    for dataset in args.datasets:
        for num_classes in args.num_classes:
            ...
            log_dir_name = f'frames-short_action-loso-{num_classes}classes' if num_classes != 3 else 'frames-short_action-loso'
            purpose = f"short_action_net-{num_classes}classes:{args.remark}" 
...
def parse_args():
    ...
    # [Dataset parameters] 1: 前后帧相减，2：后帧减第一帧 3：保持像素帧
